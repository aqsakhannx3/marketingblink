...
const Navbar = () => {
    return (
        ...
        <nav className=" navbar navbar-expand-lg navbar-light bg-white" >
          ...
          <button className="navbar-toggler" type="button" data-toggle="collapse" datas-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
